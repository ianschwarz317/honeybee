  ...
  return (
    <div style={{ minHeight:'100vh', background:'#FFFFFF', display:'flex', flexDirection:'column' }}>
      ...
      <div style={{ padding:'24px', display:'flex', alignItems:'center', gap:8 }}>
        ...
        <span style={{ fontWeight:700, fontSize:15, letterSpacing:'-0.02em', color:'#0A0A0A' }}>Honeybee</span>
      </div>

      <div style={{ flex:1, display:'flex', flexDirection:'column', justifyContent:'center', padding:'0 24px 80px', maxWidth:440, margin:'0 auto', width:'100%' }}>

        {screen === 'role-select' && (
          <div className="fade-up">
            <h1 style={{ fontSize:32, fontWeight:700, letterSpacing:'-0.02em', marginBottom:8, color:'#0A0A0A' }}>Welcome back.</h1>
            <p style={{ fontSize:15, color:'#6B7280', marginBottom:40, lineHeight:1.5 }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:12, marginBottom:32 }}>
              {[
                ...
                <button
                  ...
                  style={{ width:'100%', padding:'20px', background:'#FFFFFF', border:'1px solid #EBEBEB', borderRadius:'8px', cursor:'pointer', textAlign:'left', transition:'border-color 0.15s ease-out', display:'flex', alignItems:'center', justifyContent:'space-between' }}
                  onMouseEnter={e => { e.currentTarget.style.borderColor = '#E8820C' }}
                  onMouseLeave={e => { e.currentTarget.style.borderColor = '#EBEBEB' }}
                >
                  <div>
                    <div style={{ fontSize:15, fontWeight:600, marginBottom:4, color:'#0A0A0A', letterSpacing:'-0.01em' }}>{title}</div>
        ...
        {(screen === 'login' || screen === 'signup') && (
          <form onSubmit={handleSubmit} className="fade-up">
            <button
              ...
              style={{ background:'none', border:'none', color:'#6B7280', cursor:'pointer', fontSize:14, fontFamily:'inherit', marginBottom:32, padding:0, display:'flex', alignItems:'center', gap:6 }}
            >
              ← Back
            </button>

            <h1 style={{ fontSize:28, fontWeight:700, letterSpacing:'-0.02em', marginBottom:6, color:'#0A0A0A' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:24, marginBottom:32 }}>
              {screen === 'signup' && (
                <div>
                  <label style={{ fontSize:12, fontWeight:500, color:'#6B7280', display:'block', marginBottom:8 }}>Full Name</label>
              ...
              <div>
                <label style={{ fontSize:12, fontWeight:500, color:'#6B7280', display:'block', marginBottom:8 }}>Email</label>
              ...
              <div>
                <label style={{ fontSize:12, fontWeight:500, color:'#6B7280', display:'block', marginBottom:8 }}>Password</label>
